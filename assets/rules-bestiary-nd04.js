(function(global){
  ...
  function register(entries,options){
  ...
  function list(filters){
    ...
    return DATA.filter(function(creature){return (!query||creature.searchText.indexOf(query)>=0)&&(nd==='all'||creature.catalogNd===nd);}).map(clone);
  }
