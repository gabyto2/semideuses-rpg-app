(function(global){
  ...
  function apply(c,raw){
    ...
    var panoplyId=String(m.panoplyId||'');var pan=panoplyId&&db.getMythicItem?db.getMythicItem(panoplyId):null;if(!pan||pan.tier!=='Panóplia')panoplyId='';
    c.mythic={panoplyId:panoplyId,consumables:cleanConsumables(m.consumables||[])};
    c.rules=c.rules||{};c.rules.mythic={panoply:panoplyId?db.getMythicItem(panoplyId):null,consumableCount:c.mythic.consumables.length};
    return c;
  }
  ...
  function create(o){var raw=Object.assign({mythic:{panoplyId:'',consumables:[]}},o||{});return apply(oldCreate(raw),raw);}
  ...
  Model.version='3e-model-0.9.0';Model.panoply=panoply;Model.panoplyAwakenings=panoplyAwakenings;Model.mythicConsumable=consumable;Model.normalize=normalize;Model.calculate=calculate;Model.create=create;
})(window);
